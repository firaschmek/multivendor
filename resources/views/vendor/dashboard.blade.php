            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-green-600 mt-2">
                        <i class="fas fa-check-circle"></i> {{ $stats['active_products'] }} active
                    </p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                <h4 class="text-lg font-semibold">This Month</h4>
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between">
                    <span>Revenue:</span>
                    <span class="font-bold">{{ number_format($stats['monthly_revenue'], 0) }} TND</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                <h4 class="text-lg font-semibold">Stock Alerts</h4>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                <h4 class="text-lg font-semibold">Commission</h4>
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-bold">{{ number_format($stats['total_commission'], 0) }} TND</span>
                </div>
            </div>
        </div>
    </div>
                ...
                @forelse($recent_orders as $order)
                    <div class="flex items-center justify-between py-3 border-b last:border-b-0">
                        ...
                        <div class="text-right">
                            <div class="font-bold text-gray-800">{{ number_format($order->orderItems->sum('subtotal'), 2) }} TND</div>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($top_products as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-gray-800 font-medium">{{ number_format($product->price, 2) }} TND</td>
                            <td class="px-6 py-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="{{ route('vendor.orders.index') }}" class="bg-green-50 hover:bg-green-100 text-green-700 p-4 rounded-lg text-center transition">
                ...
                <div class="font-medium">View Orders</div>
            </a>
            <a href="{{ route('vendor.shop.edit') }}" class="bg-purple-50 hover:bg-purple-100 text-purple-700 p-4 rounded-lg text-center transition">
                ...
                <div class="font-medium">Shop Settings</div>
            </a>
