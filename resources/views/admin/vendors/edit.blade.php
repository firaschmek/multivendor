...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <form action="{{ route('admin.vendors.update', $vendor) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $vendor->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_ar" 
                              rows="4"
                              dir="rtl"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description_ar', $vendor->description_ar) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    @else
                        <p class="text-gray-500">No banner uploaded</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div>
                ...
                <select name="status" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                    <option value="approved" {{ old('status', $vendor->status) === 'approved' ? 'selected' : '' }}>Approved (Active)</option>
                    <option value="pending" {{ old('status', $vendor->status) === 'pending' ? 'selected' : '' }}>Pending (Requires Approval)</option>
                    <option value="suspended" {{ old('status', $vendor->status) === 'suspended' ? 'selected' : '' }}>Suspended (Inactive)</option>
                </select>
            </div>
        </div>
