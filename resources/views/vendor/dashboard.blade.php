...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-6 text-white">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between">
                    <span>الإيرادات:</span>
                    <span class="font-bold">{{ number_format($stats['monthly_revenue'], 0) }} د.ت</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-md p-6 text-white">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-bold">{{ number_format($stats['total_commission'], 0) }} د.ت</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="p-6">
                @forelse($recent_orders as $order)
                    <div class="flex items-center justify-between py-3 border-b last:border-b-0">
                        ...
                        <div class="text-left">
                            <div class="font-bold text-gray-800">{{ number_format($order->orderItems->sum('subtotal'), 2) }} د.ت</div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="p-6 border-b flex items-center justify-between">
                <h3 class="text-lg font-bold text-gray-800">تنبيه المخزون المنخفض</h3>
            ...
            <div class="p-6">
                @forelse($low_stock_products as $product)
                    <div class="flex items-center justify-between py-3 border-b last:border-b-0">
                        <div class="flex items-center gap-3 flex-1">
                            ...
                            @endif
                            <div>
                                <div class="font-medium text-gray-800">{{ $product->name_ar ?? $product->name }}</div>
                ...
                @empty
                    <div class="text-center py-8 text-gray-500">
                        ...
                        <p>جميع المنتجات لديها مخزون كافي</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6 border-b">
            <h3 class="text-lg font-bold text-gray-800">أكثر المنتجات مبيعاً</h3>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">المبيعات</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($top_products as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-gray-800 font-medium">{{ number_format($product->price, 2) }} د.ت</td>
                            <td class="px-6 py-4">
